...
def redrawWindow(win, game, player):
    ...
    if not(game.connected()):
        ...
        text = font.render("Waiting for Players...", 1, (255,255,255), True)
        ...
        if game.turn == player:
            ...
            font = pygame.font.SysFont("comicsans", 60)
            text = font.render("Opponent\'s Move", 1, (255, 0,0))
            win.blit(text, (50, 50))
        ...
        if player == 0: cardsToDraw = game.p1Cards
        
        elif player == 1: cardsToDraw = game.p2Cards
            
        elif player == 2: cardsToDraw = game.p3Cards
        
        elif player == 3: cardsToDraw = game.p4Cards
